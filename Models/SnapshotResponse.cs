namespace AutoTrader.Models
{
    ...
    public class SnapshotResponse
    {
        ...
        {
            OpenPositions = snapshot != null && snapshot.open_positions != null ? snapshot.open_positions.Where(op => !string.IsNullOrWhiteSpace(op.tradeId)) : new List<SR_OpenPosition>();
            Message = message;
        }
    }
}
